...
//markers
  ...
  static final CameraPosition _kGooglePlex =
      const CameraPosition(target: LatLng(37.819722, -122.478611), zoom: 15);
                ...
                onTap: () async {
                  ...
                  if (place != null) {
                    ...
                    setState(() async {
                      LatLng? newlatlang = LatLng(lat, lang);
                      location = place.description.toString();
                      final GoogleMapController cntrlr =
                          await _controller.future;

                      cntrlr.animateCamera(CameraUpdate.newCameraPosition(
                          CameraPosition(target: newlatlang, zoom: 19)));
                      _marker.add(
                        Marker(
