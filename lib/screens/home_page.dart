...
class _DietPlansState extends State<DietPlans> {
  ...
  static List image_url = [
    "assets/ketofood6.jpg",
    "assets/ketofood7.jpg",
    "assets/lunch13.jpg",
    "assets/ketofood4.jpg",
    "assets/breakfast14.jpg",
    "assets/P2.jpg",
    "assets/P3.jpg",
    "assets/lunch3.jpg",
    "assets/breakfast13.jpg",
    "assets/lunch15.jpg"
  ];
  final List<Plans> diet_data = List.generate(
      plan_title.length,
      (index) => Plans(
          title: '${plan_title[index]}',
          desc: '${plan_desc[index]}',
          price: '${plan_price[index]}',
